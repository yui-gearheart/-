本遊戲是用python開發的科幻風格回合制自動戰鬥遊戲，玩家可以選擇5名英雄挑戰不同的BOSS，或與其他玩家進行5v5對戰。
...
本遊戲分為挑戰BOSS和玩家對戰兩種模式

1.在下方選擇隊伍的1的5位英雄

2.若選擇挑戰BOSS，則在上方選擇要挑戰的BOSS，若選擇玩家對戰，則在上方選擇隊伍2的5位英雄

3.在右方選擇遊戲進行速度（默認為慢速）

4.點擊「開始戰鬥」，即開始戰鬥，雙方輪流使用技能，戰鬥記錄顯示在中央消息框中，隊伍1的戰鬥資訊用綠色顯示，隊伍2的戰鬥資訊用藍色顯示
